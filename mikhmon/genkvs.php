...
<?php
	if(isset($_POST['uprofile'])){
		...
		$u2= rand(10000000,99999999);
		$u3= rand(10000000,99999999);
		$u4= rand(10000000,99999999);
		$u5= rand(10000000,99999999);
		$u6= rand(10000000,99999999);
		$u7= rand(10000000,99999999);
		$u8= rand(10000000,99999999);
		$u9= rand(10000000,99999999);
		$u10= rand(10000000,99999999);
		$u11= rand(10000000,99999999);
		$u12= rand(10000000,99999999);
		$u13= rand(10000000,99999999);
		$u14= rand(10000000,99999999);
		$u15= rand(10000000,99999999);
		$u16= rand(10000000,99999999);
		$u17= rand(10000000,99999999);
		$u18= rand(10000000,99999999);
		$u19= rand(10000000,99999999);
		$u20= rand(10000000,99999999);
		$u21= rand(10000000,99999999);
		$p1= $u1;
		$p2= $u2;
		$p3= $u3;
		$p4= $u4;
