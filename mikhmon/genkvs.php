...
<?php
	if(isset($_POST['uprofile'])){
		...
		$n1= rand(100,999);
		$u1 = "$a1$n1";
		$a2= substr(str_shuffle("ABCDEFGHIJKLMNOPQRSTUVWXYZ"), -3);
		$n2= rand(100,999);
		$u2 = "$a2$n2";
		$a3= substr(str_shuffle("ABCDEFGHIJKLMNOPQRSTUVWXYZ"), -3);
		$n3= rand(100,999);
		$u3 = "$a3$n3";
		$a4= substr(str_shuffle("ABCDEFGHIJKLMNOPQRSTUVWXYZ"), -3);
		$n4= rand(100,999);
		$u4 = "$a4$n4";
		$a5= substr(str_shuffle("ABCDEFGHIJKLMNOPQRSTUVWXYZ"), -3);
		$n5= rand(100,999);
		$u5 = "$a5$n5";
		$a6= substr(str_shuffle("ABCDEFGHIJKLMNOPQRSTUVWXYZ"), -3);
		$n6= rand(100,999);
		$u6 = "$a6$n6";
		$a7= substr(str_shuffle("ABCDEFGHIJKLMNOPQRSTUVWXYZ"), -3);
		$n7= rand(100,999);
		$u7 = "$a7$n7";
		$a8= substr(str_shuffle("ABCDEFGHIJKLMNOPQRSTUVWXYZ"), -3);
		$n8= rand(100,999);
		$u8 = "$a8$n8";
		$a9= substr(str_shuffle("ABCDEFGHIJKLMNOPQRSTUVWXYZ"), -3);
		$n9= rand(100,999);
		$u9 = "$a9$n9";
		$a10= substr(str_shuffle("ABCDEFGHIJKLMNOPQRSTUVWXYZ"), -3);
		$n10= rand(100,999);
		$u10 = "$a10$n10";
		$a11= substr(str_shuffle("ABCDEFGHIJKLMNOPQRSTUVWXYZ"), -3);
		$n11= rand(100,999);
		$u11 = "$a11$n11";
		$a12= substr(str_shuffle("ABCDEFGHIJKLMNOPQRSTUVWXYZ"), -3);
		$n12= rand(100,999);
		$u12 = "$a12$n12";
		$a13= substr(str_shuffle("ABCDEFGHIJKLMNOPQRSTUVWXYZ"), -3);
		$n13= rand(100,999);
		$u13 = "$a13$n13";
		$a14= substr(str_shuffle("ABCDEFGHIJKLMNOPQRSTUVWXYZ"), -3);
		$n14= rand(100,999);
		$u14 = "$a14$n14";
		$a15= substr(str_shuffle("ABCDEFGHIJKLMNOPQRSTUVWXYZ"), -3);
		$n15= rand(100,999);
		$u15 = "$a15$n15";
		$a16= substr(str_shuffle("ABCDEFGHIJKLMNOPQRSTUVWXYZ"), -3);
		$n16= rand(100,999);
		$u16 = "$a16$n16";
		$a17= substr(str_shuffle("ABCDEFGHIJKLMNOPQRSTUVWXYZ"), -3);
		$n17= rand(100,999);
		$u17 = "$a17$n17";
		$a18= substr(str_shuffle("ABCDEFGHIJKLMNOPQRSTUVWXYZ"), -3);
		$n18= rand(100,999);
		$u18 = "$a18$n18";
		$a19= substr(str_shuffle("ABCDEFGHIJKLMNOPQRSTUVWXYZ"), -3);
		$n19= rand(100,999);
		$u19 = "$a19$n19";
		$a20= substr(str_shuffle("ABCDEFGHIJKLMNOPQRSTUVWXYZ"), -3);
		$n20= rand(100,999);
		$u20 = "$a20$n20";
		$a21= substr(str_shuffle("ABCDEFGHIJKLMNOPQRSTUVWXYZ"), -3);
		$n21= rand(100,999);
		$u21 = "$a21$n21";
		$p1= $u1;
		$p2= $u2;
