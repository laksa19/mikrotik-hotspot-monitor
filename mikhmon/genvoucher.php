	...
	<body>
		<div class="main">
			...
			<table>
				<tr>
					<td colspan=3>
						<button class="btnsubmit" onclick="window.open('./vouchers/voucher.html','_blank');">Cetak</button>
						</td>
				</tr>
			<br>
			</table>
